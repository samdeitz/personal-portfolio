...
const TechnologyIcon = ({ technology }) => {
    ...
    return (
        <a href={techInfo[technology].href} target="_blank" className="group block perspective-[1000px] cursor-default w-max">
            <div className="relative transition-transform duration-400 transform-3d group-hover:rotate-y-180">
                ...
                {/* back */}
                <div className={`absolute top-0 left-0 w-full h-full p-2 flex items-center justify-center backface-hidden rotate-y-180 pointer-events-none ${isDark ? "bg-dark-grey" : "bg-light-grey"} border rounded-xl`}>
